...
class Job(Base):
    ...
    city: Mapped[str | None] = mapped_column(sa.String(128))
    state: Mapped[str | None] = mapped_column(sa.String(64))
    ...
    raw_description: Mapped[str | None] = mapped_column(sa.Text)
...
class DailySnapshot(Base):
    ...
    avg_salary_junior: Mapped[int | None] = mapped_column(sa.Integer)
    avg_salary_mid: Mapped[int | None] = mapped_column(sa.Integer)
    avg_salary_senior: Mapped[int | None] = mapped_column(sa.Integer)
    created_at: Mapped[datetime] = mapped_column(
        sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False
    )
