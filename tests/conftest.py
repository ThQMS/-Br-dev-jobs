...
def sample_raw_jobs() -> list[RawJob]:
    ...
    return [
        RawJob(
            ...
            city="São Paulo",
            state="SP",
            url="https://gupy.io/jobs/1",
            salary_raw="R$ 12.000 - R$ 18.000",
            contract_type_raw="clt",
        ...
        RawJob(
            ...
            city="São Paulo",
            state="SP",
            url="https://gupy.io/jobs/2",
            salary_raw="R$ 8.000 a R$ 12.000",
            contract_type_raw="pj",
            description="React, TypeScript, Node.js",
        ),
        RawJob(
            source="linkedin",
            external_id="l1",
            title="Dev Python Junior",
            company="Big Bank SA",
        ...
        RawJob(
            ...
            company="E-commerce SA",
            city="Curitiba, PR",
            url="https://indeed.com/jobs/1",
            salary_raw="R$ 10.000 - R$ 14.000",
            contract_type_raw="clt",
